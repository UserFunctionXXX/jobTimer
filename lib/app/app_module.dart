...
import 'package:job_timer/app/core/database/database_app_impl.dart';
...
class AppModule extends Module {
  ...
  List<Bind> get binds => [
        ...
        Bind.lazySingleton<DatabaseApp>((i) => DatabaseAppImpl()),
        Bind.lazySingleton<ProjectRepository>((i) => ProjectRepositoryImpl(databaseApp: i())),
